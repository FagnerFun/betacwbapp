...
{
    [Activity(Label = "MenuUsuarioActivity", Theme = "@android:style/Theme.Light.NoTitleBar.Fullscreen")]
    public class MenuUsuarioActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            _lstMenu.Add(new Dominio.Entidade.Menu() { Id = 1, Descricao = "Cadastrar usuário", Titulo = "Novo", Imagem = "usuarioadd" });
            _lstMenu.Add(new Dominio.Entidade.Menu() { Id = 2, Descricao = "Definir privilégios a um usuário", Titulo = "Permissões", Imagem = "usuarioconfig" });
